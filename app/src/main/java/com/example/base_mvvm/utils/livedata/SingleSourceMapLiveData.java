...
public class SingleSourceMapLiveData<F, R> extends MutableLiveData<R> {
    private androidx.lifecycle.LiveData<F> lastSource;
    private F lastData;
    ...
    private final androidx.lifecycle.Observer<F> observer = new androidx.lifecycle.Observer<F>() {
        @Override
     ...
     * @param source
     */
    public void setSource(androidx.lifecycle.LiveData<F> source) {
