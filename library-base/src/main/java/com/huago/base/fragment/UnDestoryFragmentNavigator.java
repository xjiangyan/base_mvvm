package com.huago.base.fragment;
...
public class UnDestoryFragmentNavigator
        extends Navigator<UnDestoryFragmentNavigator.Destination> {
    private static final String TAG = "UnDestoryFragmentNavigator";
    ...
    public UnDestoryFragmentNavigator(@NonNull Context context, @NonNull FragmentManager manager,
                                      int containerId) {
        mContext = context;
    ...
    @NonNull
    @Override
    public UnDestoryFragmentNavigator.Destination createDestination() {
        return new UnDestoryFragmentNavigator.Destination(this);
    }
    ...
    @Nullable
    @Override
    public NavDestination navigate(@NonNull UnDestoryFragmentNavigator.Destination destination, @Nullable Bundle args,
...
//        ft.replace(mContainerId, frag);
        ...
        if (navigatorExtras instanceof UnDestoryFragmentNavigator.Extras) {
            UnDestoryFragmentNavigator.Extras extras = (UnDestoryFragmentNavigator.Extras) navigatorExtras;
    ...
    private int getDestId(@Nullable String backStackName) {
        ...
        if (split.length != 2) {
            throw new IllegalStateException("Invalid back stack entry on the "
                    + "UnDestoryNavHostFragment's back stack - use getChildFragmentManager() "
    ...
    /**
     * NavDestination specific to {@link UnDestoryFragmentNavigator}
     */
    ...
    public static class Destination extends NavDestination {
        ...
        public Destination(@NonNull NavigatorProvider navigatorProvider) {
            this(navigatorProvider.getNavigator(UnDestoryFragmentNavigator.class));
        }
         ...
         * Fragment via {@link #setClassName(String)}.
         *
         * @param fragmentNavigator The {@link UnDestoryFragmentNavigator} which this destination
         *                          will be associated with. Generally retrieved via a
         *                          {@link NavController}'s
         *                          {@link NavigatorProvider#getNavigator(Class)} method.
         */
        public Destination(@NonNull Navigator<? extends UnDestoryFragmentNavigator.Destination> fragmentNavigator) {
         ...
         *                  destination
         * @return this {@link UnDestoryFragmentNavigator.Destination}
         */
        @NonNull
        public final UnDestoryFragmentNavigator.Destination setClassName(@NonNull String className) {
    ...
    /**
     * Extras that can be passed to UnDestoryFragmentNavigator to enable Fragment specific behavior
     */
    public static final class Extras implements Navigator.Extras {
        ...
        /**
         * Builder for constructing new {@link UnDestoryFragmentNavigator.Extras} instances. The resulting instances are
         * immutable.
         */
        public static final class Builder {
             ...
             * @return this {@link UnDestoryFragmentNavigator.Extras.Builder}
             */
            @NonNull
            public UnDestoryFragmentNavigator.Extras.Builder addSharedElements(@NonNull Map<View, String> sharedElements) {
             ...
             */
            @NonNull
            public UnDestoryFragmentNavigator.Extras.Builder addSharedElement(@NonNull View sharedElement, @NonNull String name) {
                mSharedElements.put(sharedElement, name);
                return this;
            }

            /**
             * Constructs the final {@link UnDestoryFragmentNavigator.Extras} instance.
             *
             * @return An immutable {@link UnDestoryFragmentNavigator.Extras} instance.
             */
            @NonNull
            public UnDestoryFragmentNavigator.Extras build() {
                return new UnDestoryFragmentNavigator.Extras(mSharedElements);
            }
        }
    }
}
