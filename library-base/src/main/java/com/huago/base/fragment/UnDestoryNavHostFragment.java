 ...
 * @updateDes 2020/7/2
 */
public class UnDestoryNavHostFragment extends Fragment implements NavHost {
     ...
     * looking first for a {@link UnDestoryNavHostFragment} along the given Fragment's parent chain.
    ...
    public static NavController findNavController(@NonNull Fragment fragment) {
        ...
        while (findFragment != null) {
            if (findFragment instanceof UnDestoryNavHostFragment) {
                return ((UnDestoryNavHostFragment) findFragment).getNavController();
            }
            Fragment primaryNavFragment = findFragment.requireFragmentManager()
                    .getPrimaryNavigationFragment();
            if (primaryNavFragment instanceof UnDestoryNavHostFragment) {
                return ((UnDestoryNavHostFragment) primaryNavFragment).getNavController();
            }
    ...
    /**
     * Create a new UnDestoryNavHostFragment instance with an inflated {@link NavGraph} resource.
     *
     * @param graphResId resource id of the navigation graph to inflate
     * @return a new UnDestoryNavHostFragment instance
     */
    @NonNull
    public static UnDestoryNavHostFragment create(@NavigationRes int graphResId) {
    ...
    public static UnDestoryNavHostFragment create(@NavigationRes int graphResId,
        ...
        final UnDestoryNavHostFragment result = new UnDestoryNavHostFragment();
        if (b != null) {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (mGraphId != 0) {
            ...
            // See if it was set by UnDestoryNavHostFragment.create()
     ...
     * <p>
     * By default, this adds a {@link UnDestoryFragmentNavigator}.
     * <p>
    ...
    /**
     * Create the UnDestoryFragmentNavigator that this UnDestoryNavHostFragment will use. By default, this uses
     * {@link UnDestoryFragmentNavigator}, which replaces the entire contents of the UnDestoryNavHostFragment.
     * <p>
     * This is only called once in {@link #onCreate(Bundle)} and should not be called directly by
     * subclasses.
     *
     * @return a new instance of a UnDestoryFragmentNavigator
     * @deprecated Use {@link #onCreateNavController(NavController)}
     */
    @SuppressWarnings("DeprecatedIsStillUsed")
    @Deprecated
    @NonNull
    protected Navigator<? extends UnDestoryFragmentNavigator.Destination> createFragmentNavigator() {
        return new UnDestoryFragmentNavigator(requireContext(), getChildFragmentManager(), getId());
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        // hierarchy in cases where the UnDestoryNavHostFragment is added programmatically as is required
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        // the View that has the ID matching this UnDestoryNavHostFragment.
